...
describe('CanvasNodeGroupTitleBar', () => {
	...
	describe('AC #1 — chevron caption and icon by state', () => {
	...
	describe('AC #2 — height invariant; nodrag on interactive children', () => {
	...
	describe('AC #3 — frame visibility', () => {
	...
	describe('AC #7 — execution-status classes', () => {
	...
	describe('AC #11 / title rename + ungroup parity with old overlay', () => {
